...
class WebSecurity(
  ...
  fun authenticationTokenFilter(): AuthenticationTokenFilter {
    return AuthenticationTokenFilter(userDetailsServiceAdapter, jwtUtils)
  }
    ...
    http.csrf { it.disable() }
      ...
      .authorizeHttpRequests {
        it.requestMatchers("/**/actuator/**").permitAll()
          ...
          .requestMatchers("/file-management-system/api/auth/**").permitAll()
          .requestMatchers("/file-management-system/api/users/**").permitAll()
